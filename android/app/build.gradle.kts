...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "BACKEND_BASE_URL", "\"https://ais-dev-ismh65qytqyygtlgs2uot5-165288989744.asia-southeast1.run.app\"")
    }
    ...
    buildTypes {
        release {
            ...
            signingConfig = signingConfigs.getByName("debug") // Replace with production keystore for Google Play
        }
        debug {
